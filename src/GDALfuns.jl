...
@c Union{} GDALAllRegister () libgdal
...
@c Union{} GDALDestroyDriver (GDALDriverH,) libgdal
@c Cint GDALRegisterDriver (GDALDriverH,) libgdal
@c Union{} GDALDeregisterDriver (GDALDriverH,) libgdal
@c Union{} GDALDestroyDriverManager () libgdal
...
@c Union{} GDALInitGCPs (Cint, Ptr{GDAL_GCP}) libgdal
@c Union{} GDALDeinitGCPs (Cint, Ptr{GDAL_GCP}) libgdal
...
@c Union{} GDALApplyGeoTransform (Ptr{Cdouble}, Cdouble, Cdouble, Ptr{Cdouble}, Ptr{Cdouble}) libgdal
...
@c Union{} GDALEndAsyncReader (GDALDatasetH, GDALAsyncReaderH) libgdal
...
@c Union{} GDALGetOpenDatasets (Ptr{Ptr{GDALDatasetH}}, Ptr{Cint}) libgdal
@c Cint GDALGetAccess (GDALDatasetH,) libgdal
@c Union{} GDALFlushCache (GDALDatasetH,) libgdal
...
@c Union{} GDALGetBlockSize (GDALRasterBandH, Ptr{Cint}, Ptr{Cint}) libgdal
...
@c Union{} GDALComputeRasterMinMax (GDALRasterBandH, Cint, Ptr{Cdouble}) libgdal
...
@c Union{} GDALARUnlockBuffer (GDALAsyncReaderH,) libgdal
@c Cint GDALGeneralCmdLineProcessor (Cint, Ptr{Ptr{Ptr{UInt8}}}, Cint) libgdal
@c Union{} GDALSwapWords (Ptr{Void}, Cint, Cint, Cint) libgdal
@c Union{} GDALCopyWords (Ptr{Void}, GDALDataType, Cint, Ptr{Void}, GDALDataType, Cint, Cint) libgdal
@c Union{} GDALCopyBits (Ptr{GByte}, Cint, Cint, Ptr{GByte}, Cint, Cint, Cint, Cint) libgdal
...
@c Union{} GDALDestroyColorTable (GDALColorTableH,) libgdal
...
@c Union{} GDALSetColorEntry (GDALColorTableH, Cint, Ptr{GDALColorEntry}) libgdal
@c Union{} GDALCreateColorRamp (GDALColorTableH, Cint, Ptr{GDALColorEntry}, Cint, Ptr{GDALColorEntry}) libgdal
@c GDALRasterAttributeTableH GDALCreateRasterAttributeTable () libgdal
@c Union{} GDALDestroyRasterAttributeTable (GDALRasterAttributeTableH,) libgdal
...
@c Union{} GDALRATSetValueAsString (GDALRasterAttributeTableH, Cint, Cint, Ptr{UInt8}) libgdal
@c Union{} GDALRATSetValueAsInt (GDALRasterAttributeTableH, Cint, Cint, Cint) libgdal
@c Union{} GDALRATSetValueAsDouble (GDALRasterAttributeTableH, Cint, Cint, Cdouble) libgdal
@c Union{} GDALRATSetRowCount (GDALRasterAttributeTableH, Cint) libgdal
...
@c Union{} GDALRATDumpReadable (GDALRasterAttributeTableH, Ptr{FILE}) libgdal
...
@c Union{} GDALSetCacheMax (Cint,) libgdal
@c Cint GDALGetCacheMax () libgdal
@c Cint GDALGetCacheUsed () libgdal
@c Union{} GDALSetCacheMax64 (GIntBig,) libgdal
